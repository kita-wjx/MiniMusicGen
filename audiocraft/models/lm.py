...
class LMModel(StreamingModule):
    ...
    def forward(self, sequence: torch.Tensor,
        ...
        # print("input_.shape=",input_.shape) # [B, 1601, 1024]
        ...
        input_, cross_attention_input = self.fuser(input_, condition_tensors) # [B, 1601, 1024] [B,secs/32,1024]
        # print("input_111.shape=",input_.shape) # [B, 1601, 1024]
        out = self.transformer(input_, cross_attention_src=cross_attention_input)
        
        if self.out_norm:
            out = self.out_norm(out)
        logits = torch.stack([self.linears[k](out) for k in range(K)], dim=1)  # [B, K, S, card]
        # print("logits.shape=",logits.shape) # [B, 4, 1601, 2048]
    ...
    def _sample_next_token(self,
        ...
        # print("next_token.shape=", next_token.shape, "probs.shape=", probs.shape)
        return next_token
    ...
    def generate(self,
        ...
        # cat_probs = torch.tensor([]).to(device)
        with self.streaming():
