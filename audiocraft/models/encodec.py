...
class EncodecModel(CompressionModel):
    ...
    def encode(self, x: torch.Tensor, vector: bool = False) -> tp.Tuple[torch.Tensor, tp.Optional[torch.Tensor]]:
    ...
    def decode(self, codes: torch.Tensor, scale: tp.Optional[torch.Tensor] = None) -> torch.Tensor:
