...
class MusicGen:
    ...
    def generate(self, descriptions: tp.List[str], progress: bool = False, return_token: bool = False) \
    ...
    def generate_with_chroma(self, descriptions: tp.List[str], melody_wavs: MelodyType,
                             melody_sample_rate: int, progress: bool = False) -> tp.Union[torch.Tensor,
                                                                      tp.Tuple[torch.Tensor, torch.Tensor]]:
    ...
    def _prepare_tokens_and_attributes(
        ...
        Args:
            descriptions (list of str): A list of strings used as text/image/video conditioning.
            prompt (torch.Tensor): A batch of waveforms used for continuation.
